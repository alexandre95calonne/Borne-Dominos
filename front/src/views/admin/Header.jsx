        ...
        <>
            <div className="h-32 bg-slate-800 flex ">
                ...
                <div className="text-white text-lg flex justify-between ml-10 items-center">
                    <Link to="/admin"><p className="pl-6">Products</p></Link>
                    <Link to="/admin/ingredients"><p className="pl-6">Stocks</p></Link>
                    <Link to="/admin/history"><p className="pl-6">Orders</p></Link>
                </div>
            </div>
        </>
